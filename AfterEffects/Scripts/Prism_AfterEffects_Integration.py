...
class Prism_AfterEffects_Integration(object):
	...
	def addIntegration(self, installPath):
		try:
			...
			### INSTALATION ###
			cmds = []
			origdir = os.path.join(integrationBase,"Windows", "prism.aep")
			targetdir = os.path.normpath(os.path.join(installPath, "prism.aep"))
	...
	def removeIntegration(self, installPath):
		try:
			...
			# 		os.remove(fPath)
			targetdir = os.path.join(installPath, "prism.aep")
			shutil.rmtree(targetdir)
